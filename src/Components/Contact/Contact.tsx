  ...
  return (
    <div className='contact'>
        <div className="contact-col">
            <h3>Send us a message! <img src={msg_icon} alt="Contact Us icon" /></h3>
            ...
            <ul>
                <li><img src={mail_icon} alt="Edusity Mail Icon" />EducityContact@email.com</li>
                <li><img src={phone_icon} alt="Phone contact icon" />+1 123-456-7890</li>
        ...
        <div className="contact-col">
            <form>
                ...
                <button type='submit' className='btn dark-btn'>Submit now <img src={white_arrow} alt="Submit message icon" /></button>
            </form>
            <span></span>
        </div>
    </div>
