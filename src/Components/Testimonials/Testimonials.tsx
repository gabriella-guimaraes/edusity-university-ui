        ...
        <div className="slider">
            <ul ref={slider}>
                <li>
                    <div className="slide">
                        <div className="user-info">
                            <img src={user_1} alt="users profile pic" />
                            <div>
                                <h3>William Jackson</h3>
                                <span>Edusity, USA</span>
                            </div>
                        </div>
                        <p>Choosing to pursue my degree at Edusity was one of the best decisions I've made. The supportive
                ...
                <li>
                    <div className="slide">
                        <div className="user-info">
                            <img src={user_2} alt="users profile pic" />
                            <div>
                                <h3>William Jackson</h3>
                                <span>Edusity, USA</span>
                            </div>
                ...
                <li>
                    <div className="slide">
                        <div className="user-info">
                            <img src={user_3} alt="users profile pic" />
                            <div>
                                <h3>William Jackson</h3>
                                <span>Edusity, USA</span>
                            </div>
                ...
                <li>
                    <div className="slide">
                        <div className="user-info">
                            <img src={user_4} alt="users profile pic" />
                            <div>
                                <h3>William Jackson</h3>
                                <span>Edusity, USA</span>
                            </div>
